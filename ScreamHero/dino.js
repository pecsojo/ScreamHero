  ...
  function drawLoop(time) {
      ...
      if (recordingStarted) {     
        if (pitchVolume >= minimum_volume) {
          width = 0;
          Runner.prototype.onKeyDown(document.dispatchEvent(new KeyboardEvent('keydown', { 'keyCode': 32, 'which': 32 })));
          Runner.prototype.onKeyUp(document.dispatchEvent(new KeyboardEvent('keyup', { 'keyCode': 32, 'which': 32 })));
...
handleEvent: function(e) {
  return (function(evtType, events) {
    switch (evtType) {
      ...
      this.onKeyDown(e); console.log("KEYDOWN"); console.log(e); console.log(this);
      break;
      case events.KEYUP:
      case events.TOUCHEND:
      case events.MOUSEUP:
      this.onKeyUp(e); console.log("KEYUP"); console.log(e); console.log(this);
      break;
    }
